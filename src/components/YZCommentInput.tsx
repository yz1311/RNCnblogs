...
export default class YZCommentInput extends Component<IProps,IState> {
    ...
    render() {
        const {menuComponent, onSubmit, placeholder, editable, submitButtonText, minLength, headerTitle, renderHeader, headerTiteStyle} = this.props
        ...
        else if(headerTitle)
        {
            headerComponent = (
                <View style={{paddingTop:13,paddingBottom:3,paddingLeft:8}}>
                    <Text style={[{color:gColors.color666,fontSize:gFont.size15},headerTiteStyle]}>{headerTitle}</Text>
                </View>
            );
        }
        ...
        return (
            <View
                ...
                style={{position:isToggle?'absolute':'relative',bottom:0,left:0,right:0,backgroundColor:isToggle?'rgba(0, 0, 0, 0.5)':'transparent',}}
                ...
                <TouchableOpacity
                    ...
                    style={{flex:1}} />
                <View style={{position:!isToggle?'absolute':'relative',marginBottom:isToggle?-this.contentHeight:0,backgroundColor:gColors.bgColorF, opacity:isToggle?1:0,borderTopColor:gColors.borderColor,borderTopLeftRadius:6,borderTopRightRadius:6}}>
                    {headerComponent}
                    <View style={{paddingLeft:8,paddingVertical:isToggle?10:0,
                        ...
                        >
                            <Text style={{color:!canSubmit?gColors.color999:gColors.themeColor,fontSize:gFont.size15}}>{submitButtonText}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                    <View style={{flexDirection:'row',paddingVertical:8,
                        paddingLeft:10,alignItems:'center',backgroundColor:gColors.bgColorF,opacity:!isToggle?1:0}}
