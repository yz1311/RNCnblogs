            ...
            <View style={[styles.inputItem,this.props.wrapperStyle]}>
                ...
                <View style={{height: 50, justifyContent: 'center',flex:1}}>
                    <TextInput
                        ...
                        style={[{fontSize: gFont.size14,color:gColors.themeColor,height:50, alignSelf:'stretch',marginLeft:10}, gScreen.isAndroid && {padding: 0},this.props.style]}
                        value={this.props.value}
                        onChangeText={(text)=>{
                            const {secureTextEntry,numberOnly,numberAndLetterOnly} = this.props;
                            if(text=='')
                            {
