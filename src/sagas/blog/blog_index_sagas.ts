...
export function* getBlogDetail(action) {
    ...
    //获取第一页评论列表
    yield fork(getBlogCommentList,createSagaAction(actionTypes.BLOG_GET_BLOG_COMMENT_LIST,{
        request: {
...
export function* watchBlogIndex() {
    yield all([
        takeOrCancel(actionTypes.BLOG_GET_PERSONAL_BLOGLIST, actionTypes.BLOG_CLEAR_PERSONAL_BLOGLIST, getPersonalBlogList),
        takeOrCancel(actionTypes.BLOG_GET_PICKED_BLOGLIST, actionTypes.BLOG_CLEAR_PICKED_BLOGLIST, getPickedBlogList),
        takeOrCancel(actionTypes.BLOG_GET_HOME_BLOGLIST, actionTypes.BLOG_CLEAR_HOME_BLOGLIST, getHomeBlogList),
        takeOrCancel(actionTypes.BLOG_GET_FOLLOWING_BLOGLIST, actionTypes.BLOG_CLEAR_FOLLOWING_BLOGLIST, getFollowingBlogList),
        takeOrCancel(actionTypes.BLOG_GET_DETAIL, actionTypes.BLOG_CLEAR_DETAIL, getBlogDetail),
        takeOrCancel(actionTypes.BLOG_GET_BLOG_COMMENT_LIST, actionTypes.BLOG_CLEAR_BLOG_COMMENT_LIST, getBlogCommentList),
        takeOrCancel(actionTypes.BLOG_COMMENT_BLOG, '', commentBlog),
        takeLatest(actionTypes.BLOG_SET_BLOG_SCROLL_POSITION, setBlogScrollPosition),
    ]);
}
