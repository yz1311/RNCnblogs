...
export function* getQuestionDetail(action) {
    ...
    yield* invokeCommonAPI({
        ...
        successAction: function* (action, payload) {
            yield fork(getQuestionAnswerList,createSagaAction(actionTypes.QUESTION_GET_ANSWER_LIST,{
                request: {
            ...
            for (let item of payload)
            {
                if(item.AnswerUserInfo)
                {
                    userInfoList.push({
                        ...
                        //IconName为相对路径
                        iconUrl: 'https://pic.cnblogs.com/face/'+item.AnswerUserInfo.IconName
                    });
                }
            }
...
export function* watchQuestionDetail() {
    yield all([
        takeOrCancel(actionTypes.QUESTION_GET_DETAIL, actionTypes.QUESTION_CLEAR_DETAIL, getQuestionDetail),
        takeOrCancel(actionTypes.QUESTION_GET_COMMENT_LIST, actionTypes.QUESTION_CLEAR_COMMENT_LIST, getQuestionCommentList),
        takeOrCancel(actionTypes.QUESTION_GET_ANSWER_LIST, actionTypes.QUESTION_CLEAR_ANSWER_LIST, getQuestionAnswerList),
        ...
        takeOrCancel(actionTypes.QUESTION_GET_ANSWER_COMMENT_LIST,actionTypes.QUESTION_CLEAR_ANSWER_COMMENT_LIST, getAnswerCommentList),
        takeOrCancel(actionTypes.QUESTION_COMMENT_ANSWER,'', commentAswer),
        takeOrCancel(actionTypes.QUESTION_DELETE_COMMENT_ANSWER,'', deleteAnswerComment),
        takeOrCancel(actionTypes.QUESTION_MODIFY_COMMENT_ANSWER,'', modifyAnswerComment),
