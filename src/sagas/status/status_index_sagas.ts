...
export function* getStatusDetail(action) {
  yield fork(
    getStatusCommentList,
    createSagaAction(actionTypes.STATUS_GET_COMMENT_LIST, {
      request: {
...
export function* watchStatusIndex() {
  yield all([
    takeEveryOrCancel(
      actionTypes.STATUS_GET_LIST,
      actionTypes.STATUS_CLEAR_LIST,
      getStatusList,
    ),
    takeOrCancel(
      actionTypes.STATUS_GET_DETAIL,
      actionTypes.STATUS_CLEAR_DETAIL,
      getStatusDetail,
    ),
    takeOrCancel(
      actionTypes.STATUS_GET_COMMENT_LIST,
      actionTypes.STATUS_CLEAR_COMMENT_LIST,
      getStatusCommentList,
    ),
