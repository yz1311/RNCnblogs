...
export function* getNewsDetail(action) {
  ...
  yield fork(
    getNewsCommentList,
    createSagaAction(actionTypes.NEWS_GET_COMMENT_LIST, {
      request: {
        newsId: item.Id,
        pageIndex: 1,
        pageSize: 10,
...
export function* watchNewsIndex() {
  yield all([
    takeOrCancel(
      actionTypes.NEWS_GET_LIST,
      actionTypes.NEWS_CLEAR_LIST,
      getNewsList,
    ),
    takeOrCancel(
      actionTypes.NEWS_GET_HOT_WREEK_LIST,
      actionTypes.NEWS_CLEAR_HOT_WREEK_LIST,
      getHowWeekNewsList,
    ),
    takeOrCancel(
      actionTypes.NEWS_GET_RECOMMENDED_NEWS_LIST,
      actionTypes.NEWS_CLEAR_RECOMMENDED_NEWS_LIST,
      getRecommendedNewsList,
    ),
    takeOrCancel(
      actionTypes.NEWS_GET_DETAIL,
      actionTypes.NEWS_CLEAR_DETAIL,
      getNewsDetail,
    ),
    takeOrCancel(actionTypes.NEWS_COMMENT, '', commentNews),
    takeOrCancel(
      actionTypes.NEWS_GET_COMMENT_LIST,
      actionTypes.NEWS_CLEAR_COMMENT_LIST,
      getNewsCommentList,
    ),
    ...
    takeLatest(
      actionTypes.NEWS_SET_NEWS_SCROLL_POSITION,
