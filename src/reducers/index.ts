...
import loginIndex, {State as loginIndexState} from './login/login_index_reducer';
...
import bookmarkIndex, {State as bookmarkIndexState} from './bookmark/bookmark_index_reducer';
import questionIndex from './question/question_index_reducer';
import questionDetail from './question/question_detail_reducer';
import knowledgeBaseIndex, {State as knowledgeIndexState} from './knowledgeBase/knowledgeBase_index_reducer';
import profileIndex, {State as profileIndexState} from './profile/profile_index_reducer';
