...
import {clearBlogDetail, commentBlog, getBlogDetail, getBlogCommentList, clearBlogCommentList} from "../../actions/blog/blog_index_actions";
    ...
    _renderItem=({item, index}:{item:blogCommentModel,index:number})=> {
        ...
        return (
            <CommentItem
                ...
                onDeleteCommentFn={()=>{
                    Alert.alert('','官方没有删除博客评论的api，需要跳转到网页登录后删除，是否跳转?',[{
                        text: '取消'
                    },{
                        text: '继续',
                        onPress: ()=>{
