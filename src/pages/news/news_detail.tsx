...
import {
    ...
    TouchableOpacity,
    Image,
    Text, Alert, Share, DeviceEventEmitter, Linking
} from 'react-native'
...
export default class news_detail extends YZBaseDataPage<IProps,any> {
    ...
    render() {
                ...
                commentHtml += `
                    <div style="display: flex; flex-direction: row;padding-top: 10px;">
                        ...
                        <div style="display: flex; margin-left: 10px;flex-direction: column;flex: 1;">
                            ...
                            <span style="font-size: 15px;color: #666666;margin-top: 8px;">${comment.CommentContent}</span>
        ...
        let html = `<html>
                ...
                <span style="color:#666666;font-size: small">发布于&nbsp;${item.postDateDesc}</span>
                </div>${data.body}</div>
