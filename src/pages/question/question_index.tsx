...
export default class question_index extends Component<IProps,IState> {
    ...
    constructor(props)
    {
        ...
        this.toggleActionButtonListener = DeviceEventEmitter.addListener('toggleActionButton_question',(state)=>{
            this.setState({
    ...
    render() {
        ...
        return (
            <View
                ...
                >
                    <UnsolvedQuestionList navigation={this.props.navigation} tabIndex={this.props.tabIndex}/>
                    <HighscoreQuestionList navigation={this.props.navigation} tabIndex={this.props.tabIndex}/>
                    <NoanswerQuestionList navigation={this.props.navigation} tabIndex={this.props.tabIndex}/>
                    <SolvedQuestionList navigation={this.props.navigation} tabIndex={this.props.tabIndex}/>
                    <MyQuestionList navigation={this.props.navigation} tabIndex={this.props.tabIndex}/>
                </ScrollableTabView>
