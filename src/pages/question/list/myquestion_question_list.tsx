...
@(connect(
  (state: ReduxState) => ({
    ...
    loadDataResult: state.questionIndex.myquestion.loadDataResult,
...
export default class myquestion_question_list extends BaseQuestionList<
  IProps,
  any
> {
  mustLogin = true;
