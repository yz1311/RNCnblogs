...
export default class answer_modify extends PureComponent<IProps,IState> {
    ...
    constructor(props)
    {
        ...
        this.state = {
            //修改回答
            answer: props.item.Answer || props.item.CommentContent || props.item.Content || ''
        };
    }
    ...
    render() {
        ...
        return (
            <View style={{backgroundColor: '#fff', paddingHorizontal:10, borderRadius:6, width:gScreen.width*0.9, alignItems: 'center'}}>
                <Label style={{color: '#000', marginVertical:20}} size='lg' text={title} />
                <Input
                ...
                <View style={{marginTop:20,height:50,flexDirection:'row',borderTopColor:gColors.borderColor,borderTopWidth:gScreen.onePix}}>
                    <TouchableOpacity
