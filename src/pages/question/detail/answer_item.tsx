        ...
        return (
            <TouchableOpacity
                ...
                onPress={()=>{
                    if(clickable) {
                        //由于数字需要改变，放在redux中
                        this.props.setSelectedAnswerFn(
                            item
                        );
                ...
                <View style={{backgroundColor:gColors.bgColorF,paddingVertical:10,paddingHorizontal:8}}>
                    <View style={{flexDirection:'row',alignItems:'center',marginBottom:10}}>
                        <TouchableOpacity
                            ...
                            onPress={()=>{
                                ServiceUtils.viewProfileDetail(this.props.dispatch,item.AnswerUserInfo.Alias,avator);
                            }}
                            ...
                            {AnswerUserInfo.UserName!=undefined?
                                ...
                                <View>
                                    {AnswerUserInfo.UserName!=undefined?
                                        ...
                                        >
                                            {item.AnswerUserInfo.UserName+(AnswerUserInfo.UserID==QuestionUserInfo.UserID?'(作者)':'')}
                                        </Text>
                                        :'--'}
                                </View>
                        </TouchableOpacity>
                    ...
                    <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginTop:10}}>
                        ...
                        <View style={{flexDirection:'row'}}>
                            <MaterialCommunityIcons name="message-outline" size={18} color={gColors.color333}/>
