    ...
    render() {
        ...
        return (
            <BorderShadow setting={{width:gScreen.width,border:3,color:gColors.color999}}>
                ...
                >
                    <View style={{backgroundColor:gColors.bgColorF,paddingBottom:10,paddingLeft:8}}>
                        <View style={{flexDirection:'row',alignItems:'center'}}>
                            <Text
                                style={{color:gColors.color0,fontSize:gFont.size16,fontWeight:'bold',paddingVertical:17,flex:1}}
                            >
                                {item.Title}
                            </Text>
                            <TouchableOpacity
                                ...
                                activeOpacity={activeOpacity}
                                style={{paddingTop:17,paddingHorizontal:10,paddingLeft:17,alignSelf:'stretch'}}
                        ...
                        <Text
                            style={{color:gColors.color4c,fontSize:gFont.sizeDetail,marginVertical:7}}
                        >
                            {item.LinkUrl}
                        </Text>
                        <Text
                            style={{color:gColors.color999,fontSize:gFont.size12,marginRight:10,alignSelf:'flex-end'}}
                        >
                            {item.postDateDesc}
                        </Text>
                    </View>
