            ...
            <View
                ...
                <ScrollView style={{flex:1}}>
                    <View style={{marginTop:10,alignItems:'center',minHeight:200}}>
                        <View>
                            <Text style={[styles.example_text, {fontSize: styles.example_text.fontSize*this.state.value}]}>床前明月光</Text>
                            <Text style={[styles.example_text, {fontSize: styles.example_text.fontSize*this.state.value}]}>疑是地上霜</Text>
                            <Text style={[styles.example_text, {fontSize: styles.example_text.fontSize*this.state.value}]}>举头望明月</Text>
                            <Text style={[styles.example_text, {fontSize: styles.example_text.fontSize*this.state.value}]}>低头思故乡</Text>
                        </View>
                    </View>
