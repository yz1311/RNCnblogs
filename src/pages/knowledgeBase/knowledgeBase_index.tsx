...
import {getKnowledgeBaseList, clearKnowledgeBaseList} from "../../actions/knowledgeBase/knowledgeBase_index_actions";
import BaseKnowledgeBaseList, {IBaseKnowledgeProps} from './base_knowledgeBase_list';
...
export default class knowledgeBase_index extends BaseKnowledgeBaseList<IProps,IState> {
